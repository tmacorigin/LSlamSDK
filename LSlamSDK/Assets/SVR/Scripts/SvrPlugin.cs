...
abstract class SvrPlugin
{
	...
	public virtual void SetFoveationParameters(int textureId, float focalPointX, float focalPointY, float foveationGainX, float foveationGainY, float foveationArea) {}
