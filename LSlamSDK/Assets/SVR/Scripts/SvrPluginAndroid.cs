...
class SvrPluginAndroid : SvrPlugin
{
	...
	[DllImport("svrplugin")]
	private static extern void SvrSetFoveationParameters(int textureId, float focalPointX, float focalPointY, float foveationGainX, float foveationGainY, float foveationArea);
	...
	public override void SetFoveationParameters(int textureId, float focalPointX, float focalPointY, float foveationGainX, float foveationGainY, float foveationArea)
	{
		SvrSetFoveationParameters(textureId, focalPointX, focalPointY, foveationGainX, foveationGainY, foveationArea);
	}
